...
namespace RadioSequencing
{
    ...
    public struct DeviceInfo
    {
        ...
        public string DeviceCOD3;
    }
    public struct SPartNumber
    {
    ...
    public class CPendingDataReading
    {
        public string SessionID { get; set; }
        public string UserCode { get; set; }
        public List<DataReading> Readings { get; set; } = new List<DataReading>();
    }
    static class Values
    {
       ...
       // public static DataTransferManager dtm { get; set; }
        ...
        public static List<SPartNumber> ServicePartnumbers { get; set; }
        public static CPendingDataReading PendingDataReading { get; set; }
        ...
        protected override async void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            ...
            if (resultCode == Result.Ok && requestCode == 0)
            {
                ...
                if (Result == "OK")
                {
                    ...
                    var intent = new Intent(this, typeof(InitialCheckingsActivity));
