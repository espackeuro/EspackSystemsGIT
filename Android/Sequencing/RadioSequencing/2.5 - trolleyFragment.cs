...
{
    public enum GapStatus { EMPTY,PENDING, FILLING, FILLED, ERASED, ERROR }
    ...
    public class TrolleyGap
    {
        ...
        public void FillData(DataReading data, Context context=null)
        {
            ...
            if (context !=null)
            {
                if (data.SequenceNumber != null && data.PartnumberSeqLabel == null)
                    SetStatus(GapStatus.PENDING, context);
                else if (data.Qty == 0)
    ...
    public class TrolleyClass
    {
        ...
        public void FillData(int order, DataReading data, Context context = null)
        {
            Gaps.Where(o => o.Value.Order==order).FirstOrDefault().Value.FillData(data, context);
        }
    }
    ...
    public class trolleyFragment : Fragment
    {
        ...
        public void FillData(int order, DataReading data)
        {
            Trolley.FillData(order, data, Activity);
        }
