...
namespace LoginScreen
{
    ...
    public class LoginScreenClass : AppCompatActivity
    {
        ...
        private void TxtPwd_EditorAction(object sender, TextView.EditorActionEventArgs e)
        {
            e.Handled = false;
        ...
        private async void TxtUser_EditorAction(object sender, TextView.EditorActionEventArgs e)
        {
            e.Handled = false;
                ...
                else
                {
                    ...
                    using (SqlConnection gDatos = new SqlConnection(_connectionString))
                    {
                        ...
                        using (var sp = new SqlCommand("pLogonUser", gDatos) { CommandType = CommandType.StoredProcedure })
                        {
                            ...
                            LogonDetails.User = sp.Parameters["@User"].Value.ToString();
                            LogonDetails.FullName = sp.Parameters["@@FullName"].Value.ToString();
                            LogonDetails.Password = sp.Parameters["@Password"].Value.ToString();
