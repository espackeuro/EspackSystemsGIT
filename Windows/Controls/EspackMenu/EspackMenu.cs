...
{
    public interface IEspackMenuItem
    {
        Form MDIParent();
    }
    public class EspackToolStripItem : ToolStripMenuItem, IEspackMenuItem
    {
        ...
        public Form MDIParent()
        {
            ...
            IEspackMenuItem _parent = null;
            if (Owner is IEspackMenuItem)
                _parent = (IEspackMenuItem)Owner;
            else if (OwnerItem is IEspackMenuItem)
                _parent = (IEspackMenuItem)OwnerItem;
    ...
    public class EspackMenu : MenuStrip, IEspackMenuItem
    {
