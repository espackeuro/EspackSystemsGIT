...
namespace EspackMaterialFormControls
{
    ...
    public interface EspackMaterialFormControl : EspackControl
    {
        EspackMaterialLabel CaptionLabel { get; set; }
    ...
    public class EspackMaterialLabel : MaterialLabel
    {
        EspackMaterialFormControl ParentControl { get; set; }
        ...
        public EspackMaterialLabel(string pCaption, EspackMaterialFormControl pParentControl)
        {
    ...
    public class EspackMaterialTextBox : MaterialSingleLineTextField, EspackMaterialFormControl
    {
        public EspackControlTypeEnum EspackControlType { get; set; }
        public EspackMaterialLabel CaptionLabel { get; set; }
        ...
        public EspackMaterialTextBox()
            : base()
        {
            CaptionLabel = new EspackMaterialLabel("", this) { AutoSize = true };

        }

        ~EspackMaterialTextBox()
        {
            if (CaptionLabel != null)
        ...
        //{
        //    foreach (EspackMaterialControl lControl in DependingControls)
        //    {
        //        lControl.UpdateEspackMaterialControl(EspackMaterialControlTypeEnum.DEPENDANT);
        //    }
        //}
    ...
    /*
    public class EspackMaterialMaskedTextBox : MaskedTextBox, EspackMaterialFormControl
    {
        public EspackMaterialControlTypeEnum EspackMaterialControlType { get; set; }
        public EspackMaterialLabel CaptionLabel { get; set; }
        public cAccesoDatosNet ParentConn { get; set; }
        private EnumStatus mStatus;
        private DynamicRS mDependingRS;
        ...
        //List<EspackMaterialControl> DependingControls; //list of those controls which have me as external control


        //void AddExternalControl(string pParameterName, StaticRS pRS)
        //{
        //    EspackMaterialControlType &= EspackMaterialControlTypeEnum.DEPENDANT;
        //    ExternalControls.Add(pParameterName, pRS);
        //    foreach (ControlParameter lControl in pRS.ControlParameters)
        //    {
        //        if (lControl.LinkedControl is EspackMaterialFormControl)
        //        {
        //            ((EspackMaterialFormControl)lControl.LinkedControl).DependingControls.Add(this);
        //        }
        //    }
        //}


        public EspackMaterialMaskedTextBox()
            : base()
        {
            CaptionLabel = new EspackMaterialLabel("", this) { AutoSize = true };
            var _m = new Padding();
            ...
            _m.Top = 16;
            base.Margin = _m;
            EspackMaterialTheme.changeControlFormat(this);
        }

        ~EspackMaterialMaskedTextBox()
        {
            CaptionLabel.Dispose();
            CaptionLabel = null;
        }
        ...
        public void UpdateEspackMaterialControl()
        {
            if ((EspackMaterialControlType & EspackMaterialControlTypeEnum.CTLM) == EspackMaterialControlTypeEnum.CTLM)
            {
                Text = ParentDA.SelectRS[DBField.ToString()].ToString();
            }
        }
        ...
        public void ClearEspackMaterialControl()
        {
            Text = "";
        }
    }

    public class NumericTextBox : EspackMaterialTextBox
    {
    ...
    public class EspackMaterialDateTimePicker : DateTimePicker, EspackMaterialFormControl
    {
        public EspackMaterialControlTypeEnum EspackMaterialControlType { get; set; }
        public EspackMaterialLabel CaptionLabel { get; set; }
        public cAccesoDatosNet ParentConn { get; set; }
        ...
        public EspackMaterialDateTimePicker()
        {
            CaptionLabel = new EspackMaterialLabel("", this) { AutoSize = true };
            ...
            base.Margin = _m;
            EspackMaterialTheme.changeControlFormat(this);
            CheckedChanged += EspackMaterialDateTimePicker_CheckedChanged;
        }

        private void EspackMaterialDateTimePicker_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
    ...
    public class EspackMaterialString : EspackMaterialFormControl
    {
        public EspackMaterialControlTypeEnum EspackMaterialControlType { get; set; }
    ...
    public class EspackMaterialCheckedListBox : CheckedListBox, EspackMaterialFormControl
    {
        public EspackMaterialControlTypeEnum EspackMaterialControlType { get; set; }
        public EspackMaterialLabel CaptionLabel { get; set; }
        public DynamicRS DependingRS { get; set; }
        ...
        public EspackMaterialCheckedListBox()
            : base()
        {
            CaptionLabel = new EspackMaterialLabel("", this) { AutoSize = true };
            CheckOnClick = true;
            ...
            AfterItemCheck += EspackMaterialCheckedListBox_AfterItemCheck;
        }

        private void EspackMaterialCheckedListBox_AfterItemCheck(object sender, AfterItemCheckEventArgs e)
        {
    ...
    public class EspackMaterialComboBox : ComboBox, EspackMaterialFormControl
    {
        public EspackMaterialControlTypeEnum EspackMaterialControlType { get; set; }
        public EspackMaterialLabel CaptionLabel { get; set; }
        public DynamicRS DependingRS { get; set; }
        ...
        private DynamicRS _RS;
        private string _SQL;
        public EspackMaterialTextBox TBDescription { get; set; }
        ...
        public void Source(string pSql, EspackMaterialTextBox pTB)
        {
            Source(pSql, ParentConn);
            TBDescription = pTB;
        }
