...
namespace AutomaticProcesses
{
    class cProcess
    {
        ...
        public cProcess(string server, string user, string password, string db, Nullable<int> queryNumber, string args, string title, Nullable<int> subQueryNumber = null, bool noBand = false, string fileName = null, cMiscFunctions.eFileType fileType = cMiscFunctions.eFileType.HTML, cMiscFunctions.eOrientation orientation = cMiscFunctions.eOrientation.PORTRAIT) : this(new cConnDetails(server, user, password, db), queryNumber, args, title, subQueryNumber, noBand, fileName, fileType, orientation)
        {
