    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string[] _lines = File.ReadAllLines((!cMiscFunctions.RunningOnLinux() ? Directory.GetCurrentDirectory().Substring(0, 3) + "C# Apps Settings\\" : $"/media/bin/{_myName}/") + $"{_myName}.settings", Encoding.Unicode);
